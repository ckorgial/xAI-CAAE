...
class DiscriminatorImg(nn.Module):
    ...
    def xai_forward(self, func):  #XAI Add wrapper function for Dimg forward pass
        ...
        def inner1(imgs, labels, device):  # XAI
...
class Net(object):
    ...
    def teach_encoder_generator_discriminatorZ(self, z, z_prior, generated, images, labels, losses, local_explainable, explanation_type,
                                trained_data):
    ...
    # def teach_discriminator_z(self, z, z_prior, losses):
    #     self.dz_optimizer.zero_grad()
    #
    #     # DiscriminatorZ Loss
    #     # z_prior = two_sided(torch.rand_like(z, device=self.device))  # [-1 : 1]
        ...
        for epoch in range(1, epochs + 1):
            ...
            try:
                ...
                #     labels = labels.to(device=self.device)
                    ...
                    # self.teach_discriminator_z(z.detach(), z_prior, losses)
